...
let api_port = ""; // 端口
const assets_file_dir_name = "/purehome/app/"; // 中间路由文件路径
const assets_html_dir_name = "/purehome/app/"; // 中间路由文件路径
...
const app_version = "5.5.0"; // 格式 1.0.0
const app_email = "";
